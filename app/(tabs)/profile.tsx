                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            <View style={{ flexDirection: 'column', gap: 12 }}>
                                {[
                                    ...
                                    { label: 'Esmeralda', light: 'emerald' as ThemeName, dark: 'emerald_dark' as ThemeName, lightColor: '#10B981', darkColor: '#10B981', lightText: '#ECFDF5', darkText: '#022C22' },
                                    ...
                                    { label: 'Cereza', light: 'cherry' as ThemeName, dark: 'cherry_dark' as ThemeName, lightColor: '#E11D48', darkColor: '#E11D48', lightText: '#FFF5F5', darkText: '#31040E' },
